...
3/8-3/22 
試試看VLM相關的Dataset，不一定侷限健身(當然健身很好，是我們本來目標)，視覺辨識輔助文字知識、文字知識輔助視覺，甚至需要一至多輪Reasoning的都是好議題，Dataset可以不用一次跑完，只挑4-5筆都沒關係，文字輸入(出)影像輸出(入)的pair，想一下有沒有這樣的Case，然後用閉源跑看看、也用1-2個開源SOTA跑看看，我們看結果再來討論
